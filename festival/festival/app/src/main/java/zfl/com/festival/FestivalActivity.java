...
import zfl.com.festival.festival_fragment.festival_blessing;
import zfl.com.festival.festival_fragment.festival_history;

public class FestivalActivity extends AppCompatActivity {
    private TabLayout mTablayout;
    private ViewPager mViewpager;
    private String[] mTitles = new String[]{"节日祝福","发送记录"};
    private static final int PERMISSION_REQUESTCODE = 1;//权限码
    @Override
