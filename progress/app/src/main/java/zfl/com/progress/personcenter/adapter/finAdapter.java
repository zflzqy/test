...
public class finAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            ...
            hodler.tv_nameAlevel =convertView.findViewById(R.id.fint_itname);
...
//        if (task.getFinishname()!=null){
//            hodler.tv_nameAlevel.setText("完成人："+task.getFinishname());
//        }
//        else {
//            hodler.tv_nameAlevel.setText(task.getAppraiselevel());
//        }
        if (task.getReceive_account()==0){
            hodler.tv_finaccount.setVisibility(View.GONE);//不存在则隐藏
        }else {
            hodler.tv_finaccount.setText(task.getReceive_account());//完成人账号
        }
        hodler.tv_apprise.setText("评价内容："+task.getAppraise());
        return convertView;
    }
    class viewHodler{
        TextView tv_request,tv_nameAlevel,tv_type,tv_finaccount,tv_apprise;
    }
}
