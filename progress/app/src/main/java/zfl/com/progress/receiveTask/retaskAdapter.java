...
public class retaskAdapter extends BaseAdapter {
    ...
    private Task task;
    public retaskAdapter(Context context, List<Task> mTask,Handler handler) {
        this.mTask = mTask;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView=mInflater.inflate(R.layout.frg_readpter,null);
            hoder =new ViewHodler();
            hoder.tv_request =convertView.findViewById(R.id.ret_itrq);
            hoder.tv_price =convertView.findViewById(R.id.ret_itpr);
            hoder.tv_type =convertView.findViewById(R.id.ret_ittp);
            hoder.tv_starttime =convertView.findViewById(R.id.ret_itst);
            hoder.endtime =convertView.findViewById(R.id.ret_itet);
            hoder.btn_giveup=convertView.findViewById(R.id.ret_itgu);
            hoder.btn_pay=convertView.findViewById(R.id.ret_itpay);
            convertView.setTag(hoder);
        }else {
            hoder = (ViewHodler) convertView.getTag();
        }
        task =mTask.get(position);
        log.i("okhttpTask","这是结果::::::"+task.toString());
        ...
        try {
            ...
            log.i("day", "这是第:"+task.getId()+"  "+Datechange.getDateAfter(start,task.getEndtime()));
        ...
        hoder.btn_pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //完成监听
                Message message =new Message();
